...
public final class TermuxPropertyConstants {
    ...
    public static final String DEFAULT_IVALUE_EXTRA_KEYS = "[['ESC','/',{key: '-', popup: '|'},'HOME','UP','END','PGUP'], ['DRAWER','TAB','CTRL','ALT','LEFT','DOWN','RIGHT','PGDN']]"; // Double row, custom: DRAWER button added
